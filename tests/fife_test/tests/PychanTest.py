...
class ModalTest(PyChanExample):
    ...
    def requestModal(self):
        self.widget.requestModalFocus()

    def releaseModal(self):
        self.widget.releaseModalFocus()

    def requestMouseModal(self):
        self.widget.requestModalMouseInputFocus()

    def releaseMouseModal(self):
        self.widget.releaseModalMouseInputFocus()
...
class PychanTest(test.Test):
    ...
    def create(self, engine, application):
        ...
        self.gui.min_size = (
            self._engine.getRenderBackend().getScreenWidth(),
            self._engine.getRenderBackend().getScreenHeight(),
        )
    ...
    def selectExample(self):
        ...
        self.gui.findChild(name="xmlSource").text = str(
            open(self.currentExample.xmlFile).read(), "utf8"
        )
